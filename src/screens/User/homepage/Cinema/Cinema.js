...
import CategoryGroupCinema from "../../../../components/User/CategoryGroupCinema/CategoryGroupCinema";
import CategoryGroupCinemaMobile from "../../../../components/User/CategoryGroupCinemaMobile/CategoryGroupCinemaMobile";
import GroupCinema from "../../../../components/User/GroupCinema/GroupCinema";
import * as action from "./../../../../redux/actions/cinemaActions";
...
const mapDispathToProps = (dispatch) => {
  return {
    ...
    getGroupCinemaInfo: (maHeThongRap) => {
      dispatch(action.getGroupCinemaInfoAPI(maHeThongRap));
    },
  };
};
